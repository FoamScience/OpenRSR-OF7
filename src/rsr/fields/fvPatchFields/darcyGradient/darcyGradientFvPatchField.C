...
#include "darcyGradientFvPatchField.H"
#include "addToRunTimeSelectionTable.H"
#include "linear.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::darcyGradientFvPatchField::darcyGradientFvPatchField
(
    const fvPatch& p,
...
Foam::darcyGradientFvPatchField::darcyGradientFvPatchField
(
    const darcyGradientFvPatchField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::darcyGradientFvPatchField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::darcyGradientFvPatchField::write(Ostream& os) const
{
